    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                UNITY_DEFINE_INSTANCED_PROP( float, _VO_Strength)
                UNITY_DEFINE_INSTANCED_PROP( float, _VO_SPD_U)
                UNITY_DEFINE_INSTANCED_PROP( float, _VO_SPD_V)
                UNITY_DEFINE_INSTANCED_PROP( float, _Indentations_SPD_U)
                UNITY_DEFINE_INSTANCED_PROP( float, _Indentations_SPD_V)
                UNITY_DEFINE_INSTANCED_PROP( float, _Indentation_Add)
                UNITY_DEFINE_INSTANCED_PROP( float, _Lines_SPD_U)
                UNITY_DEFINE_INSTANCED_PROP( float, _Lines_SPD_V)
                UNITY_DEFINE_INSTANCED_PROP( float, _Lines_Strength)
                UNITY_DEFINE_INSTANCED_PROP( float, _Lines_Tile_U)
                UNITY_DEFINE_INSTANCED_PROP( float, _Lines_Tile_V)
                UNITY_DEFINE_INSTANCED_PROP( float, _indentations_Tile_U)
                UNITY_DEFINE_INSTANCED_PROP( float, _Indentations_Tile_V)
                UNITY_DEFINE_INSTANCED_PROP( float, _VO_Tile_U)
                UNITY_DEFINE_INSTANCED_PROP( float, _VO_Tile_V)
                UNITY_DEFINE_INSTANCED_PROP( float, _ColorSlider)
                UNITY_DEFINE_INSTANCED_PROP( float4, _Color_1)
                UNITY_DEFINE_INSTANCED_PROP( float4, _Color_2)
                UNITY_DEFINE_INSTANCED_PROP( float, _Emissive_Strength)
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                float _VO_SPD_U_var = UNITY_ACCESS_INSTANCED_PROP( Props, _VO_SPD_U );
                float _VO_SPD_V_var = UNITY_ACCESS_INSTANCED_PROP( Props, _VO_SPD_V );
                float4 node_6735 = _Time;
                float _VO_Tile_U_var = UNITY_ACCESS_INSTANCED_PROP( Props, _VO_Tile_U );
                float _VO_Tile_V_var = UNITY_ACCESS_INSTANCED_PROP( Props, _VO_Tile_V );
                float2 node_1150 = (((float2(_VO_SPD_U_var,_VO_SPD_V_var)*node_6735.g)+o.uv0)*float2(_VO_Tile_U_var,_VO_Tile_V_var));
                float4 node_3323 = tex2Dlod(_MIX,float4(TRANSFORM_TEX(node_1150, _MIX),0.0,0));
                float _VO_Strength_var = UNITY_ACCESS_INSTANCED_PROP( Props, _VO_Strength );
                v.vertex.xyz += float3(float2(0.0,(node_3323.r*_VO_Strength_var)),0.0);
...
////// Emissive:
                ...
                float _ColorSlider_var = UNITY_ACCESS_INSTANCED_PROP( Props, _ColorSlider );
                float _Lines_Strength_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Lines_Strength );
                float _Lines_Tile_U_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Lines_Tile_U );
                float _Lines_Tile_V_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Lines_Tile_V );
                float _Lines_SPD_U_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Lines_SPD_U );
                float _Lines_SPD_V_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Lines_SPD_V );
                float4 node_6735 = _Time;
                float2 node_7944 = (float2(_Lines_Tile_U_var,_Lines_Tile_V_var)*((float2(_Lines_SPD_U_var,_Lines_SPD_V_var)*node_6735.g)+i.uv0));
                float4 node_6627 = tex2D(_MIX,TRANSFORM_TEX(node_7944, _MIX));
                float _Indentation_Add_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Indentation_Add );
                float _indentations_Tile_U_var = UNITY_ACCESS_INSTANCED_PROP( Props, _indentations_Tile_U );
                float _Indentations_Tile_V_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Indentations_Tile_V );
                float _Indentations_SPD_U_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Indentations_SPD_U );
                float _Indentations_SPD_V_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Indentations_SPD_V );
                float2 node_3595 = (float2(_indentations_Tile_U_var,_Indentations_Tile_V_var)*((float2(_Indentations_SPD_U_var,_Indentations_SPD_V_var)*node_6735.g)+i.uv0));
                float4 node_9292 = tex2D(_MIX,TRANSFORM_TEX(node_3595, _MIX));
                float4 node_4141 = tex2D(_MIX,TRANSFORM_TEX(i.uv0, _MIX));
                float node_8710 = (((_Lines_Strength_var*node_6627.a)+(_Indentation_Add_var+node_9292.b))*node_4141.g);
                float _Emissive_Strength_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Emissive_Strength );
                float3 emissive = ((lerp(_Color_1_var.rgb,_Color_2_var.rgb,(_ColorSlider_var*node_8710))*node_8710)*_Emissive_Strength_var);
